...
function updateStars() {
  //12 to 16 moves for an average score
  if(numMoves > 12 && numMoves < 16) {numStars = 2;}
  //17 or more moves for a poor score
  else if(numMoves > 17) {numStars = 1;}
  //8 to 12 moves for a perfect score
  else {numStars = 3;}
...
function makeWinMessage() {
  ...
  tempHTML += "<span class='start'>You won in " + mins + " minute(s) and "
            ...
            + " You earned a rating of " + numStars + " Star(s).</span>";
